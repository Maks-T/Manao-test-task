...
const inputChangeHandle = () => {
  ...
  inputPassword = inputsForm.find((input) => input.name === 'password');
  inputConfirmPassword = inputsForm.find(
    (input) => input.name === 'confirm-password'
  );

  if (inputPassword.value !== inputConfirmPassword.value) {
    inputConfirmPassword.setAttribute('isvalid', 'false');
  }
